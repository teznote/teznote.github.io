...
![그림00]({{ '/img/dev/web/web-0040-00.png' | relative_url }})

위와 같이 입력후, `수신 규칙 추가` 를 클릭한다. 그리고, 나머지 규칙들을 다 삭제한다. 아래와 같은 결과만 남겼다.

![그림01]({{ '/img/dev/web/web-0040-01.png' | relative_url }})
...
![그림02]({{ '/img/dev/web/web-0040-02.png' | relative_url }})
...
![그림03]({{ '/img/dev/web/web-0040-03.png' | relative_url }})
